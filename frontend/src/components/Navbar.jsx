...
export default function Navbar() {
  ...
  // Toggle dark/light mode with one function
  const toggleMode = () => {
    setMode((prev) => (prev === "light-mode" ? "dark-mode" : "light-mode"));
  };

  // Apply body class on mode change
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div id="navbar">
        ...
        <div className="nav-links">
          <div className="icons">
            <button className="nav-icons" aria-label="Notifications">
              <FaRegBell />
            </button>
            ...
            >
              {mode === "light-mode" ? <FaRegMoon /> : <CiSun />}
            </button>
